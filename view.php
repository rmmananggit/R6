...
<h1 class="text-center">Student's Data</h1>
...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-lg-9">
            ...
            <!--  Start Accepting ID that is passed from view, then GET using the ID that is passed  -->
                <?php
                    if(isset($_GET['id']))
                    {
                        $id = $_GET['id'];
                        ...
                        // Start Initializing data found in database using ID then extract
                            if(mysqli_num_rows($user_result) > 0 )
                            {
                                foreach($user_result as $user)
                                {
                ?>
            <!--  End Accepting ID that is passed from view, then GET using the ID that is passed  -->

                                <!-- Start Showing Results in Database-->
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="studentId" class="form-label">Student I.D</label>
                                            <h1 class="form-control" id="firstName">
                                                <?=$user['studentID'];?>
                                            </h1>
                                        </div>
                                ...
                                <!-- End Showing Results in Database-->
                ...
                <?php
                    ...
                    // End Initializing data found in database using ID then extract
                ?>
</div>
